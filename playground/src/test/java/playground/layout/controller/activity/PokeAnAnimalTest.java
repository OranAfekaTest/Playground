...
public class PokeAnAnimalTest {
	...
	@Test
	public void pokeAnAnimalWithVerifiedPlayerAndAnimal() throws Exception {
	...
	public void pokeAnAnimalWithUnverifiedPlayerAndAnimal() throws Exception {
		// Given database contains
		UserId     verifiedManagerId  = testHelpers.registerVerifiedManager(defaultCode);
		UserEntity verifiedManager    = userService.getUserById(verifiedManagerId.getEmail(), verifiedManagerId.getPlayground());
		String     persistedElementId = testHelpers.createElement(defaultPlayground, verifiedManager);
	...
	@Test(expected = Exception.class)
	public void pokeAnAnimalWithVerifiedManagerAndAnimal() throws Exception {
		// Given database contains
		UserId     verifiedManagerId  = testHelpers.registerVerifiedManager(defaultCode);
		UserEntity verifiedManager    = userService.getUserById(verifiedManagerId.getEmail(), verifiedManagerId.getPlayground());
		String     persistedElementId = testHelpers.createElement(defaultPlayground, verifiedManager);
	...
	@Test(expected = Exception.class)
	public void pokeAnAnimalWithVerifiedPlayerAndNotAnimal() throws Exception {
		// Given database contains
		UserId     verifiedManagerId  = testHelpers.registerVerifiedManager(defaultCode);
		UserEntity verifiedManager    = userService.getUserById(verifiedManagerId.getEmail(), verifiedManagerId.getPlayground());
