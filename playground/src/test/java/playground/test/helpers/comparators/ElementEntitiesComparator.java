...
public class ElementEntitiesComparator implements Comparator<ElementEntity> {

	@Override
	public int compare(ElementEntity e1, ElementEntity e2) {
	...
	public int compareForCreationOfNewElement(ElementEntity e1, ElementEntity e2) {
		int rv = e1.getPlayground().compareTo(e2.getPlayground());
		if (rv == 0) {
			rv = e1.getLocation().compareTo(e2.getLocation());
			if (rv == 0) {
